...
- Finally, check files inside **outputs** folder for predicted label of the TE sequence/s.
...
- Finally, check **predicted_result.csv** file inside **outputs** folder for predicted label of the TE sequence/s.

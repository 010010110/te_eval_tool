...
public class KmersFeaturesCollector {
	...
	public static void main(String[] args) throws IOException {
		...
		String id = "";
		String outputs_feature_file_path = curr_dir_path+"/feature_file.csv";
		FileWriter outputs_feature_file = new FileWriter(outputs_feature_file_path, true);
		BufferedWriter feature_bw = new BufferedWriter(outputs_feature_file);
		...
		while((id = list_rd.readLine())!=null){
			...
			String two_mer_file = curr_dir_path+"/kanalyze-2.0.0/outputs_data/2mer/"+id+".txt";
//			System.out.println(two_mer_file);
			String three_mer_file = curr_dir_path+"/kanalyze-2.0.0/outputs_data/3mer/"+id+".txt";
			String four_mer_file = curr_dir_path+"/kanalyze-2.0.0/outputs_data/4mer/"+id+".txt";
			...
			parseInputAndAppendTooutputs(two_mer_file, three_mer_file, four_mer_file, feature_wr, feature_map, neuc_type);
	...
	public static void parseInputAndAppendTooutputs(String two_mer_file, String three_mer_file, String four_mer_file, PrintWriter feature_wr, Map<String, Integer> feature_map, List<String> neuc_type) throws IOException{

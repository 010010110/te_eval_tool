...
There are two modes, count and stream. Count outputss a sorted tab-delimited file of k-mers and their counts. Stream writes a list of k-mers as they are read.
